...
public:
    ...
    LoopClosing(Atlas* pAtlas, KeyFrameDatabase* pDB, ORBVocabulary* pVoc,const bool bFixScale, const bool bActiveLC,  const string &strSettingPath, Settings* settings);
